...
static const struct msm_pingroup nord_groups[] = {
	...
	[127] = PINGROUP(127, qup1_se2_l2, qup1_se2_l0, _, atest_usb21, ddr_pxi8,
			 _, _, _, _, _, _),
	[128] = PINGROUP(128, qup1_se2_l2, qup1_se2_l0, _, atest_usb20, ddr_pxi9,
			 _, _, _, _, _, _),
	[129] = PINGROUP(129, qup1_se3_l2, qup1_se3_l0, ccu_i2c_sda8, mdp1_vsync4_out,
			 _, atest_usb21, ddr_pxi9, _, _, _, _),
	[130] = PINGROUP(130, qup1_se3_l2, qup1_se3_l0, ccu_i2c_scl8, mdp1_vsync5_out,
